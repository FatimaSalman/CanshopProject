...
public class AppErrorsManager {
    ...
    public static void showSuccessDialog(Activity context, String error) {
        if (context != null && !context.isFinishing()) {
            AlertDialog alertDialogBuilder = new AlertDialog.Builder(context)
                    .setTitle(context.getString(R.string.info)).setMessage(error).setPositiveButton(R.string.ok,
    ...
    public static void showSuccessDialog(Activity context, String title, String error,
        ...
        if (context != null && !context.isFinishing()) {
            AlertDialog alertDialogBuilder = new AlertDialog.Builder(context)
                    .setTitle(title)
                    .setMessage(error)
                    .setPositiveButton(context.getString(R.string.confirm), okClickListener)
                    .setNegativeButton(context.getString(R.string.cancel), cancelClickListener)
                    .show();
